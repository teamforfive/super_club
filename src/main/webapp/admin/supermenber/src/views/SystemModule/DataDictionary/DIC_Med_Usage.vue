    ...
    <el-table
      ...
      style="width: 100%"
       ...
       <el-table-column align="center" label="序号" width="95">
        ...
        <el-table-column label="用法编码" width="95">
          <template slot-scope="scope">{{ scope.Code }}</template>
        </el-table-column>
        <el-table-column label="用法名称" width="95">
      ...
      <el-form label-width="140px" label-position="left" ref="form" :model="form" :rules="rules">
        ...
        <el-form-item label="用法名称" :label-width="formLabelWidth" prop="Name">
...
<script>
import { getList, addList,UdList} from '@/api/DataDictionary/DIC_Med_Usage'
export default {
  filters: {
    statusFilter(status) {
      const statusMap = {
  ...
  data() {
    return {
      ...
      options: [{
        ...
        value:'',
        rules: {
        Name: [{ required: true, message: '用法名称必填！', trigger: 'blur' }],

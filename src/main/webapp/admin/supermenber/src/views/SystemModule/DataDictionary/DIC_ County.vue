<template>
 ...
 <div>
    <el-table
      ...
      <el-table-column align="center"   label="区、县编码" width="120" fixed>
        <template slot-scope="scope">
          {{ scope.row.County_Code}}
        </template>
      </el-table-column>
       <el-table-column align="center"   label="区，县名称" width="120" fixed>
        <template slot-scope="scope">
      ...
      <el-form label-width="140px" label-position="left" ref="form" :model="form" :rules="rules">
        ...
        <el-form-item label="区，县名称" prop="County_Name">
          <el-input  v-model="form.County_Name" ></el-input>
        </el-form-item>
...
<script>
import { getList, addList,UdList} from '@/api/DataDictionary/DIC_ County'
export default {
  filters: {
    statusFilter(status) {
      const statusMap = {

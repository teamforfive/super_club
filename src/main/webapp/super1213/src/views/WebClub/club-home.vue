<template>
    <div class="c-home paddbotoom">
         <mt-header class="head-top" fixed title="超级社团"></mt-header>
               <!-- 顶部下 -->
        <mt-swipe :show-indicators="false" class="club-swipe">
                <mt-swipe-item><img class="img" src="@/assets/img/4.jpg"></mt-swipe-item>
                <mt-swipe-item><img  class="img" src="@/assets/404_images/404.png"></mt-swipe-item>
        </mt-swipe>
        ...
        <div class="LHotlist mui-content">
            <ul class="mui-table-view mui-grid-view mui-grid-9">
                 <li @click="rembname(item.uuId)" class="mui-table-view-cell  mui-media mui-col-xs-3" v-for="item in readm()" :key="item.uuId">
                    ...
                    <img :src="'http://192.168.1.100:8081/SuperClub/image/'+item.clubLogo">
                    <p>{{item.clubsName}}</p>
                      </router-link>
                </li>
